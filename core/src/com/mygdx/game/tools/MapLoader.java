...
public class MapLoader implements Disposable {
    ...
    public MapLoader(World world) {
        this.mWorld = world;
        mMap = new TmxMapLoader().load("newer_map.tmx");
        ...
        for (RectangleMapObject rObject : walls) {
            ...
            ShapeFactory.createRectangle(new Vector2(rectangle.getX() + rectangle.getWidth() / 2, rectangle.getY() + rectangle.getHeight() / 2),// position (middle)
    ...
    public Body getPlayer() {
        ...
        return ShapeFactory.createRectangle(new Vector2(rectangle.getX() + rectangle.getWidth() / 2, rectangle.getY() + rectangle.getHeight() / 2),// position (middle)
                new Vector2(rectangle.getWidth() / 2, rectangle.getHeight() / 2), // size
